...
export const AGENT_MAX_TURNS = Number(env['AGENT_MAX_TURNS']) || 30
...
export const MEMORY_NUDGE_INTERVAL_TURNS = Number(env['MEMORY_NUDGE_INTERVAL_TURNS']) || 10
export const MEMORY_NUDGE_INTERVAL_HOURS = Number(env['MEMORY_NUDGE_INTERVAL_HOURS']) || 2
export const IDLE_LOCK_MINUTES = Number(env['IDLE_LOCK_MINUTES']) || 30
export const DASHBOARD_PORT = Number(env['DASHBOARD_PORT']) || 3141
export const WARROOM_PORT = Number(env['WARROOM_PORT']) || 7860
